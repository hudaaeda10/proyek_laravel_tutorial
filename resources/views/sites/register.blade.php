    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-5 col-md-6 search-course-left">
                ...
                <p>
                    Dengan bergabung bersama kami anda akan mendapaatkan kursus berdasarkan kurikulim yang sesuai dengan kebutuhan kerja, setelah anda lulus dari kursus kami di jamin akan mendapatkan pekerjaan yang anda inginkan sesuai dengan kelas kursus yang anda ikuti.
                </p>
            </div>
